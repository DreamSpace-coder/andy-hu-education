---
title: "Retrieve Data from Single Table"
...
We will take a deeper dive with character values here: [Working with Character Values](MySQL-9-Working_with_Character_Values.qmd).
...
We will take a deeper dive with temporal values here: [Working with Time](MySQL-10-Working_with_Time.qmd).
...
We will take a deeper dive with temporal values here: [Working with Numeric Data](MySQL-8-Working_with_Numeric_Data.qmd).
